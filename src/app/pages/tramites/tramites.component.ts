...
export class TramitesComponent {
  ...
  get filteredTramites() {
    return this.tramites.filter((tramite) => {
      const matchesSearch =
        tramite.title.toLowerCase().includes(this.searchTerm.toLowerCase()) ||
        tramite.description
          .toLowerCase()
          .includes(this.searchTerm.toLowerCase());
      const matchesCategory =
        !this.selectedCategory || tramite.category === this.selectedCategory;
      const matchesMinistry =
        !this.selectedMinistry || tramite.ministry === this.selectedMinistry;
